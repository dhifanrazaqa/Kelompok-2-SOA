...
const createOrderTicketValidation = [
    ...
    body('paymentStatus')
        ...
        .isIn(['PENDING', 'PAID', 'FAILED', 'REFUNDED']).withMessage('Type must be one of: PENDING, PAID, FAILED, REFUNDED'),
    body('orderStatus')
        .notEmpty().withMessage('Order status is required')
        .isIn(['NEW', 'CONFIRMED', 'CANCELLED']).withMessage('Type must be one of: NEW, CONFIRMED, CANCELLED'),
];
